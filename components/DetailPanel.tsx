...
function IconShare() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M4 11.5v5.2A3.3 3.3 0 007.3 20h9.4a3.3 3.3 0 003.3-3.3v-5.2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
        ...
        <div style={{ padding: 14 }}>
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => onSimilar?.()}
                title="View a similar entry"
                aria-label="View a similar entry"
                disabled={!canPickSimilar}
                style={{
                  width: 36,
                  height: 36,
                  borderRadius: 999,
                  ...
                  justifyContent: "center",
                  padding: 0,
                  cursor: canPickSimilar ? "pointer" : "not-allowed",
                  opacity: canPickSimilar ? 1 : 0.55,
                }}
              >
                <ShuffleIcon size={18} strokeWidth={1.9} />
              </button>
            </div>
          </div>
